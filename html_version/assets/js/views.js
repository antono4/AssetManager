...
(function (global) {
    ...
    function renderShell(innerHtml, scripts) {
        ...
        const html =
            ...
            + '<a href="#dashboard" class="brand-link"><img src="assets/img/logo.svg" alt="Logo" class="brand-image ml-2 mr-1" style="width:34px;height:34px;opacity:.95"><span class="brand-text font-weight-bold">' + H.e(companyName) + '</span></a>'
    ...
    function renderBlank(innerHtml) {
        ...
        const html =
            ...
            + '<a href="#login" class="login-hero-logo"><span class="logo-icon"><img src="assets/img/logo-mark.svg" alt="Logo" style="width:30px;height:30px"></span><span>' + Lang.t('app_name') + '</span></a>'
